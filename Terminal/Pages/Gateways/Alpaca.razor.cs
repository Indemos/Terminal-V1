...
{
  public class DemoEnvironment : IEnvironment
  {
    public Uri AlpacaTradingApi => Environments.Paper.AlpacaTradingApi;
    public Uri AlpacaDataApi => Environments.Live.AlpacaDataApi;
    public Uri AlpacaStreamingApi => Environments.Paper.AlpacaStreamingApi;
    public Uri AlpacaDataStreamingApi => new("wss://stream.data.alpaca.markets/v2/test");
